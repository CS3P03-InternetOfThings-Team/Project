...
import { useAuth, useSession } from '../domain/layer';
...
function signInComponent (){
  const {
   ...
   const handleLogin = async (e : any) => {
    ...
    const {data, error}= await authenticate(body);
    if (error){
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h1 className="h1">¡Bienvenido!<br></br> Inicia sesión para continuar</h1>
            </div>
            ...
            <div className="max-w-sm mx-auto">
              ...
              <form>
                ...
                <div className="flex flex-wrap -mx-3 mt-6">
                  <div className="w-full px-3">
                    <button className="btn text-white bg-purple-600 hover:bg-purple-700 w-full" onClick={handleLogin}>Login</button>
                  </div>
                </div>
              </form>
